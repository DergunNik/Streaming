...
namespace AccountService.UnitTests
{
    public class AccountServiceTests
    {
        ...
        public AccountServiceTests()
        {
            ...
            _accountService = new AccountService.Services.AccountService(_dbContext, _cloudinary, contentRestrictions);
        }
        ...
        public async Task CreateAccount_ShouldThrowAlreadyExists_WhenUserExists()
        {
            ...
            var ex = await Assert.ThrowsAsync<RpcException>(() => _accountService.CreateAccount(request, _mockServerCallContext.Object));
        ...
        public async Task GetAccount_ShouldThrowNotFound_WhenUserDoesNotExist()
        {
            ...
            var ex = await Assert.ThrowsAsync<RpcException>(() => _accountService.GetAccount(request, _mockServerCallContext.Object));
